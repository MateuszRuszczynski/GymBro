...
urlpatterns = [
    ...
    path(
        "exercises/create/", views.ExerciseCreateView.as_view(), name="exercise-create"
    ),
    path(
        "exercises/<int:pk>/",
    ...
    path(
        "musclegroups/", views.MuscleGroupListView.as_view(), name="muscle-group-list"
    ),
    path(
        "musclegroups/create/",
    ...
    path(
        "gymusers/<int:pk>/", views.GymUserDetailView.as_view(), name="gym-user-detail"
    ),
    path(
        "gymusers/<int:pk>/update/",
        views.GymUserUpdateView.as_view(),
        name="gym-user-update",
    ),
    path(
        "gymusers/<int:pk>/delete/",
        views.GymUserDeleteView.as_view(),
        name="gym-user-delete",
    ),
    path("workoutlogs/", views.WorkoutLogListView.as_view(), name="workout-log-list"),
    path(
        "workoutlogs/create/",
        views.WorkoutLogCreateView.as_view(),
        name="workout-log-create",
    ),
    path(
        "workoutlogs/<int:pk>/",
        views.WorkoutLogDetailView.as_view(),
        name="workout-log-detail",
    ),
    path(
        "workoutlogs/<int:pk>/update/",
        views.WorkoutLogUpdateView.as_view(),
        name="workout-log-update",
    ),
    path(
        "workoutlogs/<int:pk>/delete/",
        views.WorkoutLogDeleteView.as_view(),
        name="workout-log-delete",
    ),
    path(
        "workoutplans/", views.WorkoutPlanListView.as_view(), name="workout-plan-list"
    ),
    path(
        "workoutplans/create/",
